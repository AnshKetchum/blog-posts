...
#include "solution_optimized.fatbin.c"
...
# 18 "src/solution_optimized.cu"
}
# 1 "build_optimized/solution_optimized.cudafe1.stub.c"
static void __nv_cudaEntityRegisterCallback( void **__T3) {  __nv_dummy_param_ref(__T3); __nv_save_fatbinhandle_for_managed_rt(__T3); __cudaRegisterEntry(__T3, ((void ( *)(const float *, const float *, float *, int, int, int))matrix_multiplication_kernel), _Z28matrix_multiplication_kernelPKfS0_Pfiii, (-1)); }
